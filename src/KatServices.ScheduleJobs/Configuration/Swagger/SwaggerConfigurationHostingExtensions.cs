...
using KatServices.ScheduleJobs.Configuration.Swagger;
using KatServices.ScheduleJobs.Options;
using Microsoft.Extensions.Options;
using System.Reflection;
using KatServices.ScheduleJobs.Configuration.Swagger.Filters;
...
public static class SwaggerConfigurationHostingExtensions
{
    ...
    public static IApplicationBuilder UseSwaggerInApp(this IApplicationBuilder builder)
    {
        ...
        {
            options.DocumentTitle = "Kat ScheduleJobs";
